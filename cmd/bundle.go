...
func init() {
	...
	bundleNewCmd.Flags().StringP("template-type", "t", "", "Name of the new bundle template")
	bundleNewCmd.Flags().StringSliceP("connections", "c", []string{}, "Connections to add to the bundle")
