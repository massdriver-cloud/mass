...
import (
	...
	"github.com/massdriver-cloud/mass/internal/commands/artifact"
...
func TestArtifactImport(t *testing.T) {
	...
	got, err := artifact.RunImport(t.Context(), &mdClient, "artifact-name", "massdriver/fake-artifact-schema", "testdata/artifact.json")
