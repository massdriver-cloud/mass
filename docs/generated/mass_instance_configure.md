---
id: mass_instance_configure.md
slug: /cli/commands/mass_instance_configure
title: Mass Instance Configure
sidebar_label: Mass Instance Configure
---
## mass instance configure
...
```
mass instance configure <project>-<env>-<manifest> [flags]
```

### Examples

```
mass instance configure ecomm-prod-vpc --params=params.json
```
